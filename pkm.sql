...
--
-- Host: 127.0.0.1
-- Generation Time: May 05, 2020 at 11:40 AM
...
(1, 'Ghany', 'ILPRES BEM', '081330306336', '-', 'bem_ghany', '12345678'),
(2, 'Jasmine', 'ILPRES EM', '082124186975', '-', 'bem_jasmine', '12345678');
...
--
-- Error reading structure for table pkm.detil_kriteria: #1932 - Table 'pkm.detil_kriteria' doesn't exist in engine
-- Error reading data for table pkm.detil_kriteria: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'FROM `pkm`.`detil_kriteria`' at line 1
