                ...
                @foreach($detail_kriteria as $dk )
                    <tr>
                        ...
                        <td>
                            ...
                            <!-- Button trigger modal -->
                            <button type="button" class="badge badge-success" data-toggle="modal" data-target="#editModal{{ $dk->ID_JENIS_KRITERIA }}{{ $dk->ID_BIDANG }}">
                            ...
                            <!-- Modal -->
                            <div class="modal fade" id="editModal{{ $dk->ID_JENIS_KRITERIA }}{{ $dk->ID_BIDANG }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-scrollable" role="document">
                                <div class="modal-content">
                                <div class="modal-header">
                            ...
                            <!-- Button trigger modal -->
                                ...
                                data-target="#exampleModal{{ $dk->ID_JENIS_KRITERIA }}{{ $dk->ID_BIDANG }}"><svg class="bi bi-trash-fill" width="20px" height="20px" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <!-- Modal -->
                            <!-- <div class="modal fade" id="exampleModal{{ $dk->ID_JENIS_KRITERIA }}{{ $dk->ID_BIDANG }}" tabindex="0" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
